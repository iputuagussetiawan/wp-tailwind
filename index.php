          ...
          <div class="flex min-w-full grow flex-col overflow-visible focus-within:pause hover:pause">
            <div role="marquee" aria-label="partner logos carousel" class="flex min-w-[100%] grow select-none gap-elementXSmall overflow-hidden [animation-play-state:inherit] lg:gap-elementSmall">
              <div class="animate-partner-carousel flex min-w-[100%] shrink-0 items-center justify-around overflow-visible [animation-play-state:inherit] [gap:inherit]">
                <a class="my-[calc(theme(spacing.elementXSmall)/2)] grid aspect-video shrink-0 grow-0 place-items-center justify-center px-inc40 md:my-[calc(theme(spacing.elementSmall)/2)] h-[96px] w-[176px] lg:h-[128px] lg:w-[336px] rounded-inc40 border-black20 bg-containerLight shadow-partnerCard duration-inc30 hover:scale-105" href="https://cloud.mongodb.com/ecosystem/confluent" target="_blank" rel="noreferrer" tabindex="0">
                ...
                <a class="my-[calc(theme(spacing.elementXSmall)/2)] grid aspect-video shrink-0 grow-0 place-items-center justify-center px-inc40 md:my-[calc(theme(spacing.elementSmall)/2)] h-[96px] w-[176px] lg:h-[128px] lg:w-[336px] rounded-inc40 border-black20 bg-containerLight shadow-partnerCard duration-inc30 hover:scale-105" href="https://cloud.mongodb.com/ecosystem/databricks" target="_blank" rel="noreferrer" tabindex="0">
                ...
                <a class="my-[calc(theme(spacing.elementXSmall)/2)] grid aspect-video shrink-0 grow-0 place-items-center justify-center px-inc40 md:my-[calc(theme(spacing.elementSmall)/2)] h-[96px] w-[176px] lg:h-[128px] lg:w-[336px] rounded-inc40 border-black20 bg-containerLight shadow-partnerCard duration-inc30 hover:scale-105" href="/products/platform/atlas-cloud-providers/aws" target="_blank" rel="noreferrer" tabindex="0">
                ...
                <a class="my-[calc(theme(spacing.elementXSmall)/2)] grid aspect-video shrink-0 grow-0 place-items-center justify-center px-inc40 md:my-[calc(theme(spacing.elementSmall)/2)] h-[96px] w-[176px] lg:h-[128px] lg:w-[336px] rounded-inc40 border-black20 bg-containerLight shadow-partnerCard duration-inc30 hover:scale-105" href="/products/platform/atlas-cloud-providers/google-cloud" target="_blank" rel="noreferrer" tabindex="0">
                ...
                <a class="my-[calc(theme(spacing.elementXSmall)/2)] grid aspect-video shrink-0 grow-0 place-items-center justify-center px-inc40 md:my-[calc(theme(spacing.elementSmall)/2)] h-[96px] w-[176px] lg:h-[128px] lg:w-[336px] rounded-inc40 border-black20 bg-containerLight shadow-partnerCard duration-inc30 hover:scale-105" href="https://cloud.mongodb.com/ecosystem/" target="_blank" rel="noreferrer" tabindex="0">
                ...
                <a class="my-[calc(theme(spacing.elementXSmall)/2)] grid aspect-video shrink-0 grow-0 place-items-center justify-center px-inc40 md:my-[calc(theme(spacing.elementSmall)/2)] h-[96px] w-[176px] lg:h-[128px] lg:w-[336px] rounded-inc40 border-black20 bg-containerLight shadow-partnerCard duration-inc30 hover:scale-105" href="https://cloud.mongodb.com/ecosystem/hashicorp" target="_blank" rel="noreferrer" tabindex="0">
