...
function tmdr_print_js($name, $filePath)
{
	...
	wp_enqueue_script($name, $jsPath . $filePath, [], $themeVersion, [
		"in_footer" => true,
		"strategy" => "defer",
	]);
}
...
{
	$google_font_url =
		"https://fonts.googleapis.com/css2?family=Geist:wght@100..900&family=Work+Sans:ital,wght@0,100..900;1,100..900&display=swap";
