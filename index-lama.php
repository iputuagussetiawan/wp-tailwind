    ...
    <div class="grid min-h-dvh grid-cols-1 grid-rows-[1fr_1px_auto_1px_auto] justify-center pt-14.25 [--gutter-width:2.5rem] md:-mx-4 md:grid-cols-[var(--gutter-width)_minmax(0,var(--breakpoint-2xl))_var(--gutter-width)] lg:mx-0">
      ...
      <div>
        ...
        <section class="">
          ...
          <div class="relative mt-12 line-border grid grid-cols-[1fr_1px_1fr_1px_1fr]" role="tablist" aria-orientation="horizontal">
            <button class="group relative flex items-center justify-center gap-4 p-4 focus:not-data-focus:outline-none text-gray-600 data-selected:text-indigo-600 max-lg:flex-col sm:p-6" id="headlessui-tabs-tab-:Rb8jkq:" role="tab" type="button" aria-selected="true" tabindex="0" data-headlessui-state="selected" aria-controls="headlessui-tabs-panel-:Rd8jkq:">
              <div class="absolute -inset-x-px inset-y-0 bg-indigo-500/5 group-hover:bg-indigo-500/5  not-group-data-selected:hidden">
              </div>
            ...
            <button class="group relative flex items-center justify-center gap-4 p-4 focus:outline-none text-gray-600 data-selected:text-pink-600 max-lg:flex-col sm:p-6" data-selected="true">
              <div class="absolute -inset-x-px inset-y-0 bg-pink-500/5 group-hover:bg-pink-500/5 not-group-data-selected:hidden"></div>
              <div class="text-left text-xs/5 sm:text-sm/7 xl:flex-1">
            ...
            <div class="w-px bg-gray-950/5 dark:bg-gray-50/5"></div>
            <button class="group relative flex items-center justify-center gap-4 p-4 focus:not-data-focus:outline-none text-gray-600 data-selected:text-sky-600 max-lg:flex-col sm:p-6" id="headlessui-tabs-tab-:R1b8jkq:" role="tab" type="button" aria-selected="false" tabindex="-1" data-headlessui-state="" aria-controls="headlessui-tabs-panel-:Rt8jkq:">
        ...
        <section class="line-border mt-30 grid grid-cols-1 gap-10 lg:grid-cols-2">
          <div class="lg:border-r lg:border-gray-950/5">
            <div class="grid grid-cols-1 gap-y-2 px-4 py-2 max-lg:line-b sm:px-2 lg:line-b/half">
              <h2 class="text-pink-500 font-mono text-[0.8125rem]/6 font-medium tracking-widest text-pretty uppercase text-gray-600 min-[105rem]:absolute min-[105rem]:top-0 min-[105rem]:-left-10 min-[105rem]:origin-bottom-right min-[105rem]:-translate-x-full min-[105rem]:-translate-y-full min-[105rem]:-rotate-90 min-[105rem]:pr-2">Frequently asked questions</h2>
                ...
                <div class="flex justify-center">
                  <div
                    ...
                    <button
                      ...
                      @click="activeTab = 1"
                      @focus="activeTab = 1">Lassen Peak</button>
                    <!-- Button #2 -->
                    <button
                      id="tab-2"
                      class="flex-1 text-sm font-medium h-8 px-4 rounded-2xl whitespace-nowrap focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 transition-colors duration-150 ease-in-out"
                      ...
                      @click="activeTab = 2"
                      @focus="activeTab = 2">Mount Shasta</button>
                    <!-- Button #3 -->
                    <button
                      id="tab-3"
                      class="flex-1 text-sm font-medium h-8 px-4 rounded-2xl whitespace-nowrap focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 transition-colors duration-150 ease-in-out"
                      ...
                      @click="activeTab = 3"
                      @focus="activeTab = 3">Eureka Peak</button>
                  </div>
                </div>
